...
type TKanbanColumnToolBarProps = {
  columnName: string;
  totalTasks: number;
  handleProps?: any;
  onClearColumn?: Function;
  onToggleAddTask?: MouseEventHandler<any>;
    ...
    <>
      <Stack direction="row" alignItems="center">
        <Label
          sx={{
            borderRadius: '50%',
            borderColor: (theme: TTheme) => varAlpha(theme.vars.palette.grey['500Channel'], 0.24),
          }}
        >
          {totalTasks}
        </Label>

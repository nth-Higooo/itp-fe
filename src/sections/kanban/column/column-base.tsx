...
export const StyledRoot = styled(Stack)(({ theme }: { theme: TTheme }) => ({
  flexShrink: 0,
  height: '100%',
  borderWidth: 1,
  position: 'relative',
...
type TColumnBaseProps = any;

const ColumnBase = forwardRef(({ slots, stateProps, sx, ...other }: TColumnBaseProps, ref) => {

...
export function EmployeeCertificateTableRow({ row, onDeleteRow, onEditRow }: any) {
  return (
    <>
      <TableRow hover tabIndex={-1}>
        <TableCell sx={{ whiteSpace: 'wrap' }}>{row.certificateName}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.certificateWebsite}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.toYear}</TableCell>
